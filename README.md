...
```gradle
debugImplementation 'com.ashokvarma.android:gander:3.0.0-beta3'

// if persistence is needed (Uses Room to store the calls in DB)
debugImplementation 'com.ashokvarma.android:gander-persistence:3.0.0-beta3'

// if persistence is not needed (Data lost once app is dead)
debugImplementation 'com.ashokvarma.android:gander-imdb:3.0.0-beta3'


releaseImplementation 'com.ashokvarma.android:gander-no-op:3.0.0-beta3'
```
If you want this in library in both release and debug builds, then try this : 
```gradle
implementation 'com.ashokvarma.android:gander:3.0.0-beta3'

// if persistence is needed (Uses Room to store the calls in DB)
implementation 'com.ashokvarma.android:gander-persistence:3.0.0-beta3'

// if persistence is not needed (Data lost once app is dead)
implementation 'com.ashokvarma.android:gander-imdb:3.0.0-beta3'
```
...
[mavenAarDownload]: https://repo1.maven.org/maven2/com/ashokvarma/android/gander/3.0.0-beta3/gander-3.0.0-beta3.aar
