...
```gradle
debugImplementation 'com.ashokvarma.android:gander:2.0.0'
releaseImplementation 'com.ashokvarma.android:gander-no-op:2.0.0'
```
...
[mavenAarDownload]: https://repo1.maven.org/maven2/com/ashokvarma/android/gander/2.0.0/gander-2.0.0.aar
